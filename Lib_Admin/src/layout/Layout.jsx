...
function Layout() {
  ...
  const overlays = [
    { state: showBook, setter: setShowBook },
    { state: showBookForm, setter: setShowBookForm },
    ...
    <div className="flex flex-col w-full h-screen bg-[#F5F5F6]">
      ...
      <div className="md:hidden flex items-center justify-between px-5 py-3 bg-white shadow-sm">
        <div className="navLogo flex items-center justify-center ">
          <img src={libraryLogo} alt="Library Logo" className="w-[50px] mr-2 sm:mr-4" />
      ...
      <div className="navbar hidden w-full h-[80px] md:flex items-center justify-center border-b-2">
        <div className="navLogo w-[300px] h-[80px] flex items-center justify-center">
          <img src={libraryLogo} alt="Library Logo" className="w-[60px] mr-2 md:mr-4" />
      ...
      <div className="flex overflow-y-scroll scrollbar-hide">
        ...
        >
          <div className="flex flex-col items-center gap-2 p-4 md:gap-2">
            <div className="navLogo flex items-center justify-center mb-2 md:hidden">
              <img
                src={libraryLogo}
                alt="Library Logo"
                className="w-[50px] mr-2 md:mr-4"
              />
              <h1 className="text-xl font-semibold">Library</h1>
            </div>
            {/* Navigation Links */}
            {[
              ...
              { to: "/books", icon: <PiBooksFill size={20} />, label: "Books" },
              {
                to: "/readers",
