  ...
  return (
    <div style={{
      ...
      <div className="w-full h-full flex flex-col items-center justify-center relative p-4">
        <div className="w-full max-w-[364px] bg-white shadow-md rounded-[12px] py-[24px] px-[32px] flex flex-col items-start gap-[15px] border-2 border-blue-950">
          ...
          {/* Contact Input */}
          <div className="group w-full max-w-[300px] h-[60px] flex items-center border border-black/20 rounded-full px-[26px] focus-within:border-[#2361ff]">
            <FaPhoneAlt className="text-black/20 w-[20px] h-[20px] mr-[10px] group-focus-within:text-[#2361ff]" />
            <input
              value={contact}
          ...
          {/* Email Input */}
          <div className="group w-full max-w-[300px] h-[60px] flex items-center border border-black/20 rounded-full px-[26px] focus-within:border-[#2361ff]">
            <IoMail className="text-black/20 w-[24px] h-[24px] mr-[10px] group-focus-within:text-[#2361ff]" />
            <input
              value={email}
